  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="absolute top-10 left-10 animate-float" style={{ animationDelay: '0s' }}>
        <div className="w-20 h-20 rounded-lg bg-gradient-to-br from-gray-500/30 to-blue-500/20 backdrop-blur-sm border border-gray-400/30 flex items-center justify-center transform hover:scale-110 transition-transform">
          <Code2 className="w-10 h-10 text-gray-300" />
        </div>
      </div>

      <div className="absolute top-32 right-20 animate-float" style={{ animationDelay: '1s' }}>
        <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500/25 to-fuchsia-500/15 backdrop-blur-sm border border-blue-400/30 flex items-center justify-center">
          <Zap className="w-12 h-12 text-blue-300" />
        </div>
      </div>

      <div className="absolute bottom-32 left-1/4 animate-float" style={{ animationDelay: '2s' }}>
        <div className="w-20 h-20 rounded-lg bg-gradient-to-br from-fuchsia-500/30 to-gray-500/20 backdrop-blur-sm border border-fuchsia-400/30 flex items-center justify-center">
      ...
      <div className="absolute bottom-20 right-1/4 animate-float" style={{ animationDelay: '0.5s' }}>
        <div className="w-24 h-24 rounded-full bg-gradient-to-br from-gray-500/25 to-gray-500/15 backdrop-blur-sm border border-gray-400/30 flex items-center justify-center">
      ...
      <div className="absolute top-1/3 right-1/3 animate-float" style={{ animationDelay: '3s' }}>
        <div className="w-16 h-16 rounded-lg bg-gradient-to-br from-gray-500/20 to-blue-500/10 backdrop-blur-sm border border-gray-400/20 flex items-center justify-center">
          <Train className="w-8 h-8 text-gray-200" />
        </div>
      </div>

      <div className="absolute bottom-1/4 left-1/3 animate-twinkle">
        <Star className="w-8 h-8 text-gray-300" fill="currentColor" />
      </div>
