      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden hover:border-blue-200 dark:hover:border-blue-600 transition-all duration-300"
              style={{
        ...
        <div className="mt-12 text-center bg-gradient-to-r from-blue-50 to-gray-50 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-8 border border-blue-100 dark:border-gray-600">
          ...
          <a
            ...
            className="inline-block px-8 py-3 bg-gradient-to-r from-blue-600 to-gray-600 text-white rounded-full font-medium hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 hover:scale-105"
          >
            Me contacter
          </a>
        </div>
